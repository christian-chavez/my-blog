(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.diesel = {}, global.React));
    ...
    const CoilContext = React__namespace.createContext("");
    const CoilProvider = (props) => {
        const { children } = props;
        const id = generateCoilId();
        return React__namespace.createElement(CoilContext.Provider, { value: id }, children);
    };

    const atom = (a) => a;
    const selector = (s) => s;
    const useCoilId = () => {
        const coilId = React.useContext(CoilContext);
        if (!coilId) {
    ...
    exports.CoilContext = CoilContext;
    exports.CoilProvider = CoilProvider;
    exports.atom = atom;
...
//# sourceMappingURL=diesel.umd.js.map
